<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Lawn.aspx.cs" Inherits="Event_Management_System.Lawn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div class="container-fluid">
        ...
        <br />
        <div class="container">
            <h3 class="text-center">Aamaraai Multipurpose Lawn
            </h3>
            <hr />
            <p class="text-center">
                Details about the Lawn
    ...
    <div class="container-fluid">
        ...
        <br />
        <div class="container">
            <h3 class="text-center">Available Services
            </h3>
            <hr />
            <p class="text-center">
            </p>
